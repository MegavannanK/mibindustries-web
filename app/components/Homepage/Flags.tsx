      ...
      <div className="bg-primary-100">
        <div className="w-full flex justify-center items-center p-8">
          <div className="flex w-full max-w-screen-xl flex-col items-center gap-8">
            ...
            <div className="flex w-full gap-4 justify-center  sm:gap-16">
              {currentFlags.map((url, index) => (
                <motion.div
                  ...
                  className="w-[48%] sm:w-[200px] h-[120px] rounded-lg overflow-hidden bg-primary-100 flex items-center justify-center"
                >
                  <Image
                    src={url}
                    alt={`Flag ${index}`}
