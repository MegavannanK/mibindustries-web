...
const variantDetails: Record<string, VariantDetail> = {
  ...
  // ── Spice Powders ──
  "Black Pepper Powder":       { description: "Finely ground whole peppercorns delivering a bold, sharp heat and deep aroma — the 'King of Spices' in powdered form.", origin: "Malabar Coast, Kerala", usage: "Seasoning, marinades, soups, spice blends, grilled meats.", packaging: "100 g, 250 g, 500 g, 1 kg packs; bulk 10 kg, 25 kg export bags." },
  "Coriander Powder":          { description: "Freshly ground coriander seeds offering a warm, citrusy, and earthy flavor — a staple in every Indian kitchen.", origin: "Rajasthan & Andhra Pradesh, India", usage: "Curries, dal, marinades, chutneys, vegetable dishes.", packaging: "100 g, 250 g, 500 g, 1 kg packs; bulk 10 kg, 25 kg export bags." },
  "Jeera (Cumin) Powder":      { description: "Slow-roasted and finely ground cumin delivering a warm, earthy depth of flavor that elevates any dish.", origin: "Rajasthan & Gujarat, India", usage: "Raita, curries, dal, spice blends, jeera rice, grilled meats.", packaging: "100 g, 250 g, 500 g, 1 kg packs; bulk 10 kg, 25 kg export bags." },
  "Red Chilli Powder":         { description: "Premium sun-dried red chillies ground to a fine vibrant powder — delivers consistent fiery heat and rich red color.", origin: "Guntur, Andhra Pradesh", usage: "Curries, marinades, tandoori dishes, spice blends, seasoning.", packaging: "100 g, 250 g, 500 g, 1 kg packs; bulk 10 kg, 25 kg export bags." },
  "Turmeric Powder":           { description: "Pure golden turmeric from the finest rhizomes — potent in curcumin content with an earthy, slightly bitter flavor.", origin: "Erode & Salem, Tamil Nadu", usage: "Curries, golden milk, pickles, natural remedies, Ayurvedic use.", packaging: "100 g, 250 g, 500 g, 1 kg packs; bulk 10 kg, 25 kg export bags." },
};
